                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('companies.update',$company) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <img src="{{config('app.url').'/storage/'.$company->logo}}" alt="" width="50" height="50">
                            ...
                            <div class="row mb-3">
                                <label for="web-site" class="col-md-4 col-form-label text-md-end">{{ __('Web site') }}</label>

                                <div class="col-md-6">.
                                    <input id="web-site" type="text" class="form-control" name="web_site" autocomplete="web-site" value="{{$company->web_site}}">
                                </div>
                            </div>
